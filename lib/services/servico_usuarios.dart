...
class ServicoUsuarios {
  ...
  final String _collectionUsuarios = 'usuarios';
  ...
  Future<String?> cadastrarUsuario(
    ...
    try {
      ...
      await _firestore.collection(_collectionUsuarios).doc(uid).set({
        'nome': nome,
        'cpf': cpf,
        'telefone': telefone,
        'email': email,
  ...
  Future<Usuario?> buscarDadosDoUsuario() async {
    ...
    if (userLogado != null) {
      ...
      DocumentSnapshot doc = await _firestore
          .collection(_collectionUsuarios)
          .doc(userLogado.uid)
          .get();
  ...
  Future<String?> deletarUsuario(Usuario usuario) async {
    try {
      await _firestore.collection(_collectionUsuarios).doc(usuario.id).update({
        'atualizadoEm': FieldValue.serverTimestamp(),
        'ativo': false,
      });
